...
public partial class TimelineCode : CommonMonoBehaviour
{
    ...
    public Timeline.Scenes.Scene scene;
    ...
    void AwakeTimelineCode()
    {
        ...
        scene = (Timeline.Scenes.Scene)timelines[0].scenes.GetMember(sceneName);
        scene.Start(timelines);

        //TimelineCode.Build();// This Is Default
        TimelineCode.Build = this.CustomBuild; // Reassigned, but Same function as default
        TimelineCode.Build();
    }
