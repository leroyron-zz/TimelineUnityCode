    ...
    public partial class Core
    {
        public partial class Buffer
        {
            ...
            public class Interpolation 
            {
                ...
                public float[] EvalData(float[] array, int duration, float precision, bool catmull = false, bool display = false)
                {
                    return !catmull ? SplineData(array, duration, precision, display) : CatmullData(ArrayTo2dArray(array), duration, display);
                }
                public float[] EvalData(AnimationCurve curve, int duration, float precision, bool catmull = false, bool display = false)
                {
                    float[] array = CurveToArray(curve);
                    return !catmull ? SplineData(array, duration, precision, display) : CatmullData(ArrayTo2dArray(array), duration, display);
                }
                public float[] EvalData(int index, int duration, float precision, bool catmull = false, bool display = false)
                {
            ...
            ControlPointIndex controlPoints = new ControlPointIndex();
